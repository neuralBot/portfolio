$(document).ready(function(){
	    ...
	    $(window).scroll(function(){
	        ...
	        if (isScrolledIntoView('.btn-high') === true) {
	            $('.btn-high').addClass('in-view');
	        }

	        if (isScrolledIntoView('.btn-normal') === true) {
	            $('.btn-normal').addClass('in-view');
	        }

	        if (isScrolledIntoView('.btn-basic') === true) {
	            $('.btn-basic').addClass('in-view');
	        }

	        if (isScrolledIntoView('.btn-other') === true) {
	            $('.btn-other').addClass('in-view');
	        }
